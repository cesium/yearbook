defmodule YearbookWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(YearbookWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(YearbookWeb.Gettext, "errors", msg, opts)
    end
  end
