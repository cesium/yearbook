      ...
      <div class="flex flex-col gap-8 bg-white w-full md:w-150 h-fit rounded-2xl py-8 px-5 sm:p-8 my-auto mx-5">
        ...
        >
          <.input
            ...
            class="w-full"
          />
          <.button class="w-full h-12 rounded-lg bg-primary text-white font-semibold hover:bg-primary/90 transition disabled:opacity-50 disabled:cursor-not-allowed">
        ...
        >
          ...
          <.button class="w-full h-12 rounded-lg border border-primary text-primary font-semibold hover:bg-primary/10 transition disabled:opacity-50 disabled:cursor-not-allowed">
